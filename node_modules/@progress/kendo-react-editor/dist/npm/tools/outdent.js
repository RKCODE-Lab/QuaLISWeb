    ...
    OutdentToolNS.createOutdentTool = function (settings) {
        var Tool = /** @class */ (function (_super) {
            ...
            OutdentTool.prototype.render = function () {
                ...
                var indented = !!state && kendo_editor_common_1.isIndented(state, settings.actions, buttonProps.dir);
                var listItem = state && state.schema.nodes[settings.listsTypes.listItem];
                var canListOutdent = !!state && kendo_editor_common_1.canOutdentAsListItem(state, { nodes: settings.actions, listsTypes: settings.listsTypes });
                ...
                var button = (React.createElement(kendo_react_buttons_1.Button, __assign({ onClick: function () {
                        if (view && canListOutdent) {
                            ...
                            kendo_editor_common_1.indentBlocks(settings.actions, settings.commandName, buttonProps.dir)(view.state, view.dispatch);
                        }
