...
exports.Print = function (props) {
    ...
    var button = (React.createElement(kendo_react_buttons_1.Button, __assign({ onClick: onClick, disabled: !editorWindow || editorWindow === window, title: kendo_react_intl_1.useLocalization().toLanguageString(titleKey, messages_1.messages[titleKey]) }, utils_1.onDownPreventDefault, settings.props, buttonProps)));
