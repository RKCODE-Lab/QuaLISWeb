        ...
        var Tool = /** @class */ (function (_super) {
            ...
            ListTool.prototype.render = function () {
                ...
                if (view) {
                    ...
                    var hasOl = kendo_editor_common_1.hasNode(state, nodes[types.orderedList]), hasUl = kendo_editor_common_1.hasNode(state, nodes[types.bulletList]);
...
})(ListToolNS = exports.ListToolNS || (exports.ListToolNS = {}));
