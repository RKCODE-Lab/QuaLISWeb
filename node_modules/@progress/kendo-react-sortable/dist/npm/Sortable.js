...
var Sortable = /** @class */ (function (_super) {
    ...
    function Sortable(props) {
        ...
        _this.onDragEnd = function (eventData) {
            ...
            if (onDragEnd) {
                var dragEndEvent = new SortableOnDragEndEvent_1.SortableOnDragEndEvent(_this, prevIndex, nextIndex, _this.generateNewState(prevIndex, nextIndex));
    ...
    Sortable.prototype.render = function () {
        ...
        return (React.createElement(kendo_react_common_1.Draggable, { onPress: this.onDragStart, onDrag: this.onDragOver, onRelease: this.onDragEnd, ref: this.draggableRefAssign },
