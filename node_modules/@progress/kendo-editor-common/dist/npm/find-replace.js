...
exports.findAt = function (doc, searchOptions, start, end, exit) {
...
exports.find = function (state, searchOptions) {
...
exports.findAll = function (doc, searchOptions) {
    return exports.findAt(doc, searchOptions, 0, doc.content.size, function () { return false; });
};
exports.replace = function (selection, text, transaction) {
...
exports.replaceAll = function (state, replaceText, searchOptions) {
