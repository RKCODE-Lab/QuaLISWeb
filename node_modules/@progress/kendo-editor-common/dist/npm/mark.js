 ...
 */
exports.cleanMarks = function (tr, _a) {
...
exports.styleValue = function (mark, style) {
 ...
 */
exports.selectionMarks = function (state, markType) {
    var _a = state.selection, from = _a.from, $from = _a.$from, to = _a.to, empty = _a.empty;
    var marks = [];
    if (empty) {
 ...
 */
exports.getActiveMarks = function (state, markType) {
    var marks = exports.selectionMarks(state, markType);
    var filtered = marks.filter(function (m) { return Boolean(m); });
