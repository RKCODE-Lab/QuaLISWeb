export { getHtml, setHtml, parseContent, trimWhitespace } from './source';
...
export { hasSameMarkup, getSelectionText, getNodeFromSelection, selectedLineTextOnly, canInsert, insertNode, indentHtml } from './utils';
