...
$header-cell-padding-x: $table-cell-padding !default;
$header-cell-padding-y: $table-cell-padding !default;
...
/// @group color-system
/// @type Color
$primary-contrast: $accent-contrast !default;
...
/// @group color-system
$inverse: if( $is-dark-theme, $light, $dark ) !default;
...
$subtle-text: if( $is-dark-theme, $gray-400, $text-muted ) !default;
$disabled-text: if( $is-dark-theme, $gray-600, $gray-500) !default;

$app-bg: try-shade( $body-bg, .25 ) !default;
$app-text: $body-text !default;
$app-border: contrast-yiq( $app-bg, $gray-300, $gray-700 ) !default;
...
// Header
$header-bg: contrast-wcag( $component-bg, $gray-100, $gray-900 ) !default;
