import { SchedulerEditItem, SchedulerEditSlot, 
    SchedulerSlot, SchedulerTask, SchedulerViewItem, SchedulerViewSlot } from "@progress/kendo-react-scheduler";
    ...
    return (
        <SchedulerViewSlot
            ...
            style={{
                ...props.style,
                minHeight: 5,
                cursor: !props.isWorkDay ? "no-drop" : undefined,
            }}
        />
    );
};
