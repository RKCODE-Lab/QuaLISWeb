...
class CustomViewSlotForSchCursorOnBothnonWorkend extends React.Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps, {})(CustomViewSlotForSchCursorOnBothnonWorkend);