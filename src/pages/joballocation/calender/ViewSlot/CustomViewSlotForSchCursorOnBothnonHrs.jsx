...
class CustomViewSlotForSchCursorOnBothnonHrs extends React.Component {
    constructor(props){
        super(props)
    }
    render(){
        ...
        <SchedulerViewSlot
            ...
            style={{
                ...
                backgroundColor: (
                    ...
                    ? "#c7cdd5"
                    : "",
                // cursor: !(this.props.Login.personalLeaveRestrict 
                //     && this.props.Login.calenderUserHolidays.some(x=>parseAdjustDate(x.start)===parseAdjustDate(this.props.start) )  )
                //     ||
                //     !(this.props.Login.holidaydateRestrict 
                //         && this.props.Login.calenderPublicHolidays.some(x=>parseAdjustDate(x.start)===parseAdjustDate(this.props.start) )  ) 
                ...
                //    ? "no-drop"
                //     : this.props.isWorkDay ? this.props.isWorkHour ?undefined:"no-drop":"no-drop"
                  //  : (this.props.isWorkHour!==undefined?!this.props.isWorkHour:false) ? "no-drop" : undefined,
            }}
        />
    );
        }
...
export default connect(mapStateToProps, {})(CustomViewSlotForSchCursorOnBothnonHrs);