...
class RoleAccordion extends React.Component{
    render(){
        return (
            <>
            <Tab.Content>
                <Tab.Pane aria-labelledby="Version-tab" className="p-0 active show">
                    <Row no-gutters={true}>
                        {/* <Container className="px-0"> */}
                            <Accordion activeKey={`role_${this.props.showAccordion?this.props.selectedRole.napprovalconfigrolecode:0}`}>                        
...
export default injectIntl(RoleAccordion);