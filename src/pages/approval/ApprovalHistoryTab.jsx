...
class ApprovalHistoryTab extends React.Component{  
    ...
    render(){
        ...
        {"idsName":"IDS_TESTSTATUS","dataField":"stransdisplaystatus","width":"150px"},
...
export default injectIntl(ApprovalHistoryTab);