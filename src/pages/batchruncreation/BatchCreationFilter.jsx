...
class BatchCreationFilter extends React.Component{
        ...
        return (
            <div className="side_more_filter_wrap">
                <Row>
                    ...
                    <Col md={12}>
                        ...
                        <FormSelectSearch
                            ...
                            value={this.props.RegSubTypeValue ? this.props.RegSubTypeValue : ""}
                            isMandatory={false}
                            isMulti={false}
                            isSearchable={false}
                            isDisabled={false}
              ...
              {/* <Col md={12}>
                ...
                <FormSelectSearch
                            formLabel={this.props.intl.formatMessage({ id: "IDS_BATCHSTATUS" })}
                            placeholder={this.props.intl.formatMessage({ id: "IDS_SELECTRECORD" })}
                            ...
                            value={this.props.FilterStatusValue ? this.props.FilterStatusValue : ""}
                            isMandatory={false}
                            isMulti={false}
                            isSearchable={false}
                            isDisabled={false}
                 ...
                 {!this.state.showMore ? 
                    <button className="btn_sidebar_open" onClick={this.showMoreToggle}> 
                    <FontAwesomeIcon icon={faAngleDoubleRight} />
                    </button> 
                 : ''}  
                <div className={`side_more_filter ${this.state.showMore ? 'active' : ''} `} > 
                <button className="btn_sidebar_close" onClick={this.showMoreToggle}> 
...
export default injectIntl(BatchCreationFilter)